            ...
            <div class="tab-pane vivify fadeIn delay-100 active" id="Chat-one">
                <div class="chat_detail">
                    <ul class="chat-widget clearfix">
                        ...
                        <li class="right">
                            <img src="<?php echo base_url('assets/oculux/images/xs/avatar1.jpg'); ?>" class="rounded" alt="">
                            <div class="chat-info">
            ...
            <div class="tab-pane vvivify fadeIn delay-100" id="Chat-list">
                <ul class="right_chat list-unstyled mb-0">
                    ...
                    <li class="online">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="<?php echo base_url('assets/oculux/images/xs/avatar3.jpg'); ?>" alt="">
                                <div class="media-body">
                    ...
                    <li class="online">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="<?php echo base_url('assets/oculux/images/xs/avatar5.jpg'); ?>" alt="">
                                <div class="media-body">
                                    <span class="name">Debra Stewart</span>
                                    <span class="message">online</span>
                                    <span class="badge badge-outline status"></span>
                    ...
                    <li class="offline">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="<?php echo base_url('assets/oculux/images/xs/avatar2.jpg'); ?>" alt="">
                                <div class="media-body">
                                    <span class="name">Lisa Garett</span>
