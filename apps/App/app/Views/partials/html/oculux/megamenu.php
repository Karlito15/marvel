    <div id="megamenu" class="megamenu particles_js">
        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-12">
                    <ul class="q_links">
                        <li><a href="javascript:void(0);"><i class="icon-envelope"></i><span>Inbox</span></a></li>
                        <li><a href="javascript:void(0);"><i class="icon-bubbles"></i><span>Messenger</span></a></li>
                        <li><a href="javascript:void(0);"><i class="icon-calendar"></i><span>Event</span></a></li>
                        <li><a href="javascript:void(0);"><i class="icon-user"></i><span>Profile</span></a></li>
                        <li><a href="javascript:void(0);"><i class="icon-printer"></i><span>Invoice</span></a></li>
                        <li><a href="javascript:void(0);"><i class="icon-list"></i><span>Timeline</span></a></li>
                    </ul>
                </div>
