			...
			<table class="table table-hover table-custom spacing5">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<div class="d-flex align-items-center">
								<img src="../assets/oculux/images/xs/avatar2.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded">
								<div class="ml-3">
					...
					<tr>
						...
						<td>
							<div class="d-flex align-items-center">
								<img src="../assets/oculux/images/xs/avatar5.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded">
								<div class="ml-3">
					...
					<tr>
						...
						<td>
							<div class="d-flex align-items-center">
								<img src="../assets/oculux/images/xs/avatar6.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded">
								<div class="ml-3">
	...
	<div class="col-lg-4 col-md-12">
		<a class="card" href="javascript:void(0);">
			<div class="body text-center">
				<img class="img-thumbnail rounded-circle" src="../assets/oculux/images/sm/avatar1.jpg" alt="">
