...
echo $this->include('Mephisto\Views\partials\html\oculux\stylesheets');
$this->endSection();
...
echo $this->include('Mephisto\Views\partials\html\oculux\sidebar-left');
$this->endSection();

/** Javascript */
$this->section('javascript');
echo $this->include('Mephisto\Views\partials\html\oculux\scripts');
?>
<!-- Plugins -->
